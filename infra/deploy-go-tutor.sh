...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --timeout=120 \
  --memory=512Mi \
  --set-env-vars "GOOGLE_CLOUD_PROJECT=${GOOGLE_CLOUD_PROJECT},GOOGLE_GENAI_API_KEY=${GOOGLE_GENAI_API_KEY},GO_TUTOR_MODEL=${MODEL},ENABLE_NCERT_RAG=${ENABLE_RAG},NCERT_TOP_K=${TOP_K},NCERT_VECTOR_INDEX_PATH=${INDEX_PATH},NCERT_VECTOR_INDEX_GCS_URI=${INDEX_GCS_URI},NCERT_VECTOR_INDEX_GCS_PUBLIC_URL=${INDEX_GCS_PUBLIC_URL},CONTENT_DIR=/app/content"
